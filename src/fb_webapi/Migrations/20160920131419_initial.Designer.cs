...
namespace fb_webapi.Migrations
{
    [DbContext(typeof(ApplicationDbContext))]
    [Migration("20160920131419_initial")]
    partial class initial
    {
        protected override void BuildTargetModel(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity("fb_webapi.Entities.Meal", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd();
            ...
            modelBuilder.Entity("fb_webapi.Entities.Picture", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd();
            ...
            modelBuilder.Entity("fb_webapi.Entities.User", b =>
                {
            ...
            modelBuilder.Entity("fb_webapi.Entities.Meal", b =>
                {
                    b.HasOne("fb_webapi.Entities.User", "User")
                        .WithMany("Meals")
            ...
            modelBuilder.Entity("fb_webapi.Entities.Picture", b =>
                {
                    b.HasOne("fb_webapi.Entities.Meal")
                        .WithMany("Pictures")
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.EntityFrameworkCore.IdentityUserClaim<string>", b =>
                {
                    b.HasOne("fb_webapi.Entities.User")
                        .WithMany("Claims")
                        .HasForeignKey("UserId")
                        .OnDelete(DeleteBehavior.Cascade);
                });
